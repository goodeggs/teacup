...
(function() {
  ...
  Queue = (function() {
    ...
    Queue.prototype.run = function() {
      ...
      this.running = true;
      fn = this.items.shift();
      log('Queue', this.uid, 'fn', fn);
      return fn((function(_this) {
        return function() {
          log('Queue', _this.uid, 'fn complete');
          _this.running = false;
          return _this.run();
        };
      })(this));
  ...
  Teacup = (function() {
    ...
    Teacup.prototype.render = function() {
      ...
      if (callback) {
        ...
        this.queue[0].push((function(_this) {
    ...
    Teacup.prototype.renderContents = function() {
      var contents, done, i, rest, result;
      contents = arguments[0], rest = 3 <= arguments.length ? slice.call(arguments, 1, i = arguments.length - 1) : (i = 1, []), done = arguments[i++];
      if (contents == null) {
        return typeof done === "function" ? done() : void 0;
      } else if (typeof contents === 'function') {
        if (contents.length === 0) {
          log('renderContents: sync');
          result = contents.apply(this);
          ...
          this.depth++;
          this.queue[this.depth] = new Queue({
            uid: this.depth
          });
          this.queue[this.depth].push((function(_this) {
          ...
          this.queue[this.depth].push((function(_this) {
            return function(finish) {
              log('finish queue', _this.depth);
              _this.depth--;
              finish();
              return done();
            };
          })(this));
          log('run queue', this.depth);
          return this.queue[this.depth].run();
        }
      } else {
    ...
    Teacup.prototype.tag = function() {
      ...
      log('push tag', this.depth, tagName);
      return this.queue[this.depth].push((function(_this) {
        return function(done) {
          ...
          return _this.renderContents(contents, function() {
