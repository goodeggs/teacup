 ...
 nobr spacer tt',
  ...
  Teacup = (function() {
    ...
    Teacup.prototype.tags = function() {
      var bound, method, tagName, _fn, _fn1, _fn2, _fn3, _i, _j, _k, _l, _len, _len1, _len2, _len3, _ref, _ref1, _ref2, _ref3,
        _this = this;
      bound = {};
      _ref = 'cede coffeescript comment doctype escape ie raw render renderable script tag text'.split(' ');
      _fn = function(method) {
      ...
      _ref2 = merge_elements('raw');
      _fn2 = function(tagName) {
        return bound[tagName] = function() {
          var args;
          args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
          return _this.rawTag.apply(_this, [tagName].concat(__slice.call(args)));
        };
      };
      ...
      _ref3 = merge_elements('void', 'obsolete_void');
      _fn3 = function(tagName) {
        return bound[tagName] = function() {
          var args;
          args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
