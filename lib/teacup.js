...
(function() {
  ...
  Teacup = (function() {
    ...
    Teacup.prototype.render = function() {
      var args, callback, err, error, i, previous, result, template;
      template = arguments[0], args = 3 <= arguments.length ? slice.call(arguments, 1, i = arguments.length - 1) : (i = 1, []), callback = arguments[i++];
    ...
    Teacup.prototype.renderContents = function() {
      ...
      if (contents == null) {
        ...
        if (contents.length === 0) {
          return this.queue.push("sync contents: " + contents, (function(_this) {
          ...
          return this.queue.push("async contents: " + contents, (function(_this) {
            return function(done) {
              _this.queue.position = 0;
        ...
        return this.queue.push("text contents: " + contents, (function(_this) {
          return function(done) {
            _this.queue.position = 0;
            _this.text(contents);
            return done();
    ...
    Teacup.prototype.rawTag = function() {
      ...
      return this.queue.push("raw tag: " + tagname, (function(_this) {
        return function(done) {
          var attrs, contents, ref;
          ref = _this.normalizeArgs(args), attrs = ref.attrs, contents = ref.contents;
          _this.raw("<" + tagName + (_this.renderAttrs(attrs)) + ">");
          _this.raw(contents);
          _this.raw("</" + tagName + ">");
          return done();
