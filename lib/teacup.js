...
(function() {
  var Teacup, doctypes, elements, hyphens, merge_elements, tagName, _fn, _fn1, _fn2, _i, _j, _k, _len, _len1, _len2, _ref, _ref1, _ref2,
    __slice = [].slice,
 ...
 nobr spacer tt',
  ...
  hyphens = function(s) {
    return s.replace(/([a-z\d])([A-Z])/, '$1-$2').toLowerCase();
  };
  ...
  Teacup = (function() {
    ...
    Teacup.prototype.renderContents = function(contents) {
      ...
      if (contents == null) {
        ...
        for (_i = 0, _len = contents.length; _i < _len; _i++) {
          c = contents[_i];
          _results.push(this.renderContents(c));
        }
        return _results;
    ...
    Teacup.prototype.selfClosingTag = function() {
      ...
      return this.raw("<" + tagName + (this.renderAttrs(attrs)) + " />");
    };
